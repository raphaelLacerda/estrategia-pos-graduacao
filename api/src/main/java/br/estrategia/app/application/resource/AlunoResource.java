...
@RestController
@RequestMapping(value = URI_API_PATHS.ALUNOS_API)
public class AlunoResource extends AbstractRestBaseController<Aluno, Long> {

    @Autowired
    private AlunoRepository alunoRepository;

    @Override
    public CrudRepository<Aluno, Long> getRepositorio() {
