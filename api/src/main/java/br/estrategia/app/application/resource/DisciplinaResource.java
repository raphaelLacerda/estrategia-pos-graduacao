...
@RestController
@RequestMapping(value = URI_API_PATHS.DISCIPLINAS_API)
public class DisciplinaResource extends AbstractRestBaseController<Disciplina, Long> {
    ...
    @Override
    public CrudRepository<Disciplina, Long> getRepositorio() {
        return disciplinaService.getDisciplinaRepository();
    }
}
